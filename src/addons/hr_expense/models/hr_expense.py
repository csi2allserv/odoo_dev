...
class HrExpense(models.Model):
  ...
  #-------------------------#
  #------------ gasto 1 -----------#
    product_id1 = fields.Many2one('product.product', string='Product', default=lambda self: self.env['product.product'].search([('name', '=', u'HIDRATACION')]).id, domain=[('can_be_expensed', '=', True)])
    quantity1 = fields.Float(states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, digits=dp.get_precision('Product Unit of Measure'), default=1)
    product_uom_id1 = fields.Many2one('uom.uom', readonly="True", string='Unit of Measure', default=_default_product_uom_id)
    unit_amount1 = fields.Float("Unit Price", digits=dp.get_precision('Product Price'))
    total_amount1 = fields.Monetary("Total", compute='_compute_amount1', store=True, currency_field='currency_id', digits=dp.get_precision('Account'))
  #------------ gasto 2 -----------#
    product_id2 = fields.Many2one('product.product', string='Product', readonly=True, default=lambda self: self.env['product.product'].search([('name', '=', u'DESAYUNO')]).id, domain=[('can_be_expensed', '=', True)])
    quantity2 = fields.Float( readonly=True, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, digits=dp.get_precision('Product Unit of Measure'), default=1)
    product_uom_id2 = fields.Many2one('uom.uom', string='Unit of Measure',  readonly=True, default=_default_product_uom_id)
    unit_amount2 = fields.Float("Unit Price", digits=dp.get_precision('Product Price'))
    total_amount2 = fields.Monetary("Total", compute='_compute_amount2', store=True, currency_field='currency_id', digits=dp.get_precision('Account'))
  #----------- gasto 3 ------------#
    product_id3 = fields.Many2one('product.product', string='Product', readonly=True, default=lambda self: self.env['product.product'].search([('name', '=', u'ALMUERZO')]).id, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, domain=[('can_be_expensed', '=', True)])
    quantity3 = fields.Float(readonly=True, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, digits=dp.get_precision('Product Unit of Measure'), default=1)
    product_uom_id3 = fields.Many2one('uom.uom', string='Unit of Measure', readonly=True, default=_default_product_uom_id)
    unit_amount3 = fields.Float("Unit Price", digits=dp.get_precision('Product Price'))
    total_amount3 = fields.Monetary("Total", compute='_compute_amount3', store=True, currency_field='currency_id', digits=dp.get_precision('Account'))
  #----------- gasto 4 ------------#
    product_id4 = fields.Many2one('product.product', string='Product', readonly=True, default=lambda self: self.env['product.product'].search([('name', '=', u'CENA')]).id, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, domain=[('can_be_expensed', '=', True)])
    quantity4 = fields.Float(readonly=True, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, digits=dp.get_precision('Product Unit of Measure'), default=1)
    product_uom_id4 = fields.Many2one('uom.uom', string='Unit of Measure', readonly=True, default=_default_product_uom_id)
    unit_amount4 = fields.Float("Unit Price", digits=dp.get_precision('Product Price'))
    total_amount4 = fields.Monetary("Total", compute='_compute_amount4', store=True, currency_field='currency_id', digits=dp.get_precision('Account')) 
  #----------- gasto 5 ------------#
    product_id5 = fields.Many2one('product.product', string='Product', readonly=True, default=lambda self: self.env['product.product'].search([('name', '=', u'ALOJAMIENTO')]).id, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, domain=[('can_be_expensed', '=', True)])
    quantity5 = fields.Float(readonly=True, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, digits=dp.get_precision('Product Unit of Measure'), default=1)
    product_uom_id5 = fields.Many2one('uom.uom', string='Unit of Measure',readonly=True, default=lambda self: self.env['uom.uom'].search([('name', '=', u'Día(s)')]).id)
    unit_amount5 = fields.Float("Unit Price", digits=dp.get_precision('Product Price')) 
    total_amount5 = fields.Monetary("Total", compute='_compute_amount5', store=True, currency_field='currency_id', digits=dp.get_precision('Account'))
  #----------- gasto 6 ------------#
    product_id6 = fields.Many2one('product.product', string='Product', readonly=True, default=lambda self: self.env['product.product'].search([('name', '=', u'ALOJAMIENTO ESPECIAL')]).id, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, domain=[('can_be_expensed', '=', True)])
    quantity6 = fields.Float(readonly=True, states={'draft': [('readonly', False)], 'reported': [('readonly', False)], 'refused': [('readonly', False)]}, digits=dp.get_precision('Product Unit of Measure'), default=1)
    product_uom_id6 = fields.Many2one('uom.uom', string='Unit of Measure',readonly=True, default=lambda self: self.env['uom.uom'].search([('name', '=', u'Día(s)')]).id)
    unit_amount6 = fields.Float("Unit Price", digits=dp.get_precision('Product Price')) 
    total_amount6 = fields.Monetary("Total", compute='_compute_amount6', store=True, currency_field='currency_id', digits=dp.get_precision('Account'))
  #--------------------------------#  
    ...
    complet = fields.Selection([
        ('unitario', 'Unitario'),
        ('completo', 'Completo'),        
    ], default='unitario', string='Seleccione', readonly= True, states={'draft': [('readonly', False)]})
    retorno = fields.Selection([
        ('si', 'Si'),
        ('no', 'No'),
    ], default='no', string='Retorno?', readonly= True, states={'draft': [('readonly', False)]})

    seleccion = fields.Many2one('hr.expense.multi', string='Seleccione', readonly= True, states={'draft': [('readonly', False)]})
    

    #@api.multi
    #def my_method(self):
    #   course_form = self.env.ref('multi_expenses.hr_expense_multi_form', False)
    #    return {
    #        'name': 'Completo?',
    #        'type': 'ir.actions.act_window',
    #        'res_model': 'hr.expense.multi',
    #        'view_type': 'form',
    #        'view_mode': 'form',
    #        'target': 'new',
    ...
    def _compute_state(self):
        for expense in self:
            if not expense.sheet_id or expense.sheet_id.state == 'draft':
                ...
                expense.state = "legalize"
            elif not expense.sheet_id.account_move_id:
                expense.state = "finalizado"
            elif not expense.sheet_id.account_move_id:
    ...
    @api.depends('quantity', 'unit_amount', 'tax_ids', 'currency_id','total_amount1','total_amount2', 'total_amount3', 'total_amount4','total_amount5', 'total_amount6', 'complet', 'retorno')
    def _compute_amount(self):
        for expense in self:
            expense.untaxed_amount = expense.unit_amount * expense.quantity + expense.quantity1 + expense.unit_amount1 
            expense.untaxed_amount = expense.unit_amount * expense.quantity + expense.quantity1 + expense.unit_amount1
            taxes = expense.tax_ids.compute_all(expense.unit_amount, expense.currency_id, expense.quantity, expense.product_id, expense.employee_id.user_id.partner_id)
            if expense.complet == 'unitario':
                expense.total_amount = taxes.get('total_included')
            if expense.complet == 'completo':
                expense.total_amount = expense.total_amount1 + expense.total_amount2 + expense.total_amount3 + expense.total_amount4 + expense.total_amount5 + expense.total_amount6
            if expense.retorno == 'si':
                expense.total_amount = expense.total_amount*2




  #--------------------------------------#
  #        modificaciones total 1        #
  #--------------------------------------#
    @api.depends('quantity1', 'unit_amount1', 'tax_ids', 'currency_id')
    def _compute_amount1(self):
        for expense in self:
            expense.untaxed_amount = expense.unit_amount1 * expense.quantity1
            expense.untaxed_amount = expense.unit_amount1 * expense.quantity1
            taxes = expense.tax_ids.compute_all(expense.unit_amount1, expense.currency_id, expense.quantity1, expense.product_id, expense.employee_id.user_id.partner_id)
            expense.total_amount1 = taxes.get('total_included')
  #--------------------------------------#
  #        modificaciones total 2        #
  #--------------------------------------#
    @api.depends('quantity2', 'unit_amount2', 'tax_ids', 'currency_id')
    def _compute_amount2(self):
        for expense in self:
            expense.untaxed_amount = expense.unit_amount2 * expense.quantity2
            expense.untaxed_amount = expense.unit_amount2 * expense.quantity2
            taxes = expense.tax_ids.compute_all(expense.unit_amount2, expense.currency_id, expense.quantity2, expense.product_id, expense.employee_id.user_id.partner_id)
            expense.total_amount2 = taxes.get('total_included')

  #--------------------------------------#
  #        modificaciones total 3        #
  #--------------------------------------#
    @api.depends('quantity3', 'unit_amount3', 'tax_ids', 'currency_id')
    def _compute_amount3(self):
        for expense in self:
            expense.untaxed_amount = expense.unit_amount3 * expense.quantity3
            expense.untaxed_amount = expense.unit_amount3 * expense.quantity3
            taxes = expense.tax_ids.compute_all(expense.unit_amount3, expense.currency_id, expense.quantity3, expense.product_id, expense.employee_id.user_id.partner_id)
            expense.total_amount3 = taxes.get('total_included')

  #--------------------------------------#
  #        modificaciones total 4        #
  #--------------------------------------#
    @api.depends('quantity4', 'unit_amount4', 'tax_ids', 'currency_id')
    def _compute_amount4(self):
        for expense in self:
            expense.untaxed_amount = expense.unit_amount4 * expense.quantity4
            expense.untaxed_amount = expense.unit_amount4 * expense.quantity4
            taxes = expense.tax_ids.compute_all(expense.unit_amount4, expense.currency_id, expense.quantity4, expense.product_id, expense.employee_id.user_id.partner_id)
            expense.total_amount4 = taxes.get('total_included')

  #--------------------------------------#
  #        modificaciones total 5        #
  #--------------------------------------#
    @api.depends('quantity5', 'unit_amount5', 'tax_ids', 'currency_id')
    def _compute_amount5(self):
        for expense in self:
            expense.untaxed_amount = expense.unit_amount5 * expense.quantity5
            expense.untaxed_amount = expense.unit_amount5 * expense.quantity5
            taxes = expense.tax_ids.compute_all(expense.unit_amount5, expense.currency_id, expense.quantity5, expense.product_id, expense.employee_id.user_id.partner_id)
            expense.total_amount5 = taxes.get('total_included')

  #--------------------------------------#
  #        modificaciones total 6        #
  #--------------------------------------#
    @api.depends('quantity6', 'unit_amount6', 'tax_ids', 'currency_id')
    def _compute_amount6(self):
        for expense in self:
            expense.untaxed_amount = expense.unit_amount6 * expense.quantity6
            expense.untaxed_amount = expense.unit_amount6 * expense.quantity6
            taxes = expense.tax_ids.compute_all(expense.unit_amount6, expense.currency_id, expense.quantity6, expense.product_id, expense.employee_id.user_id.partner_id)
            expense.total_amount6 = taxes.get('total_included')
    ...
    @api.onchange('complet', 'product_id')
    def _onchange_complet_id(self):
        for expense in self:
            if expense.complet == 'completo':
                self.name = 'GASTO COMPLETO'
            else:
                self.name = self.product_id.display_name or ''
                
    @api.onchange('categ_id', 'product_id')
    def _onchange_categ_id(self):
        self.categ_id = self.product_id.categoria            
...
# ----------------------------------------------------#                  
    ...
    def _onchange_product_id1(self):
        if self.product_id1:
            self.unit_amount1 = self.product_id1.price_compute('standard_price')[self.product_id1.id]
            self.product_uom_id1 = self.product_id1.uom_id
            self.tax_ids = self.product_id1.supplier_taxes_id
            account = self.product_id1.product_tmpl_id._get_product_accounts()['expense']
            if account:
                self.account_id = account
    ...
    def _onchange_product_id2(self):
        if self.product_id2:
            self.unit_amount2 = self.product_id2.price_compute('standard_price')[self.product_id2.id]
            self.product_uom_id2 = self.product_id2.uom_id
            self.tax_ids = self.product_id2.supplier_taxes_id
            account = self.product_id2.product_tmpl_id._get_product_accounts()['expense']
            if account:
                self.account_id = account

    @api.onchange('product_id3')
    def _onchange_product_id3(self):
        if self.product_id3:
            self.unit_amount3 = self.product_id3.price_compute('standard_price')[self.product_id3.id]
            self.product_uom_id3 = self.product_id3.uom_id
            self.tax_ids = self.product_id3.supplier_taxes_id
            account = self.product_id3.product_tmpl_id._get_product_accounts()['expense']
            if account:
                self.account_id = account

    @api.onchange('product_id4')
    def _onchange_product_id4(self):
        if self.product_id4:
            self.unit_amount4 = self.product_id4.price_compute('standard_price')[self.product_id4.id]
            self.product_uom_id5 = self.product_id4.uom_id
            self.tax_ids = self.product_id4.supplier_taxes_id
            account = self.product_id4.product_tmpl_id._get_product_accounts()['expense']
            if account:
                self.account_id = account

    @api.onchange('product_id5')
    def _onchange_product_id5(self):
        if self.product_id5:
            self.unit_amount5 = self.product_id5.price_compute('standard_price')[self.product_id5.id]
            self.product_uom_id5 = self.product_id5.uom_id
            self.tax_ids = self.product_id5.supplier_taxes_id
            account = self.product_id5.product_tmpl_id._get_product_accounts()['expense']
            if account:
                self.account_id = account

    @api.onchange('product_id6')
    def _onchange_product_id6(self):
        if self.product_id6:
            self.unit_amount6 = self.product_id6.price_compute('standard_price')[self.product_id6.id]
            self.product_uom_id5 = self.product_id6.uom_id
            self.tax_ids = self.product_id6.supplier_taxes_id
            account = self.product_id6.product_tmpl_id._get_product_accounts()['expense']
            if account:
                self.account_id = account
...
#-----------------------------------------------------#  
    ...
    @api.multi
    def refuse_expense_legalize(self, reason):
        self.write({'is_refused': True})
        self.sheet_id.write({'state': 'done'})
        self.sheet_id.message_post_with_view('hr_expense.hr_expense_template_refuse_reason',
                                             values={'reason': reason, 'is_sheet': False, 'name': self.name})
...
class HrExpenseSheet(models.Model):
    ...
    def _amount_all(self):
        for order in self:
            total_amount = amount_legal = 0.0
            for line in order.expense_line_ids:
                total_amount += line.total_amount
                amount_legal += line.amount_legal
            order.update({
                'total_amount': order.currency_id.round(total_amount),
                'amount_legal': order.currency_id.round(amount_legal),
                'amount_total': total_amount - amount_legal,
            })
    ...
    expense_line_ids = fields.One2many('hr.expense', 'sheet_id', string='Expense Lines', states={'approve': [('readonly', True)], 'done': [('readonly', False)], 'Legalize': [('readonly', False)], 'post': [('readonly', True)]}, copy=False)
    state = fields.Selection([
        ('draft', 'Draft'),
        ('submit', 'Submitted'),
        ('approve', 'Approved'),
    ...
    origin = fields.Many2one('maintenance.request', string='Documento origen', copy=False, readonly= True, states={'draft': [('readonly', False)], 'finalizado': [('readonly', False)]})
    ...
    amount_total = fields.Monetary(string='Total', store=True, readonly=True, states={'legalize': [('readonly', False)]}, compute='_amount_all')
    ...
    amount_legal = fields.Monetary(string='Legalizado', store=True, readonly=True, states={'legalize': [('readonly', False)]}, compute='_amount_all')
    ...
    def _track_subtype(self, init_values):
        ...
        elif 'state' in init_values and self.state == 'legalize':
            return 'hr_expense.mt_expense_legalize'
    ...
    @api.multi
    def action_finish_parcial_sheet(self):
    ...
    @api.multi
    def refuse_sheet_legalize(self, reason):
        if not self.user_has_groups('hr_expense.group_hr_expense_user'):
            raise UserError(_("Only Managers and HR Officers can approve expenses"))
        elif not self.user_has_groups('hr_expense.group_hr_expense_manager'):
            current_managers = self.employee_id.parent_id.user_id | self.employee_id.department_id.manager_id.user_id | self.employee_id.expense_manager_id
