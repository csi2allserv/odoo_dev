...
class HrExpenseRefuseSheetLegalizeWizard(models.TransientModel):
    ...
    _name = "hr.expense.refuse.sheet.legalize.wizard"
    _description = "Expense Refuse Reason Wizard"

    payment_date = fields.Date(string='Payment Date', default=fields.Date.context_today, required=True)
    reason = fields.Char(string='Monto a legalizar', required=True)
    ...
    def default_get(self, fields):
        res = super(HrExpenseRefuseSheetLegalizeWizard, self).default_get(fields)
