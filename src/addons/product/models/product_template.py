...
class ProductTemplate(models.Model):
    ...
    type = fields.Selection([
        ...
        ('service', 'Service'),
        ('viaticos', 'Viáticos'),
        ('transporte', 'Transporte')], string='Product Type', default='consu', required=True,
    ...
    #codigo modificado por william acosta, la variable categoria fue modificada de Many2many a Meny2one
    categoria = fields.Many2one('expense.all', string='categoria')
    ...
    lst_promedio = fields.Float(
        'Costo Promedio', readonly=False,
        digits=dp.get_precision('Product Price'))
